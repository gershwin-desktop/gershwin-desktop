...
* Testers can try a [gershwin-on-ghostbsd live iso](https://github.com/gershwin-desktop/gershwin-on-ghostbsd/releases/tag/continuous) (most up to date), [gershwin-on-debian live iso](https://github.com/gershwin-desktop/gershwin-on-debian/releases/tag/continuous), or [gershwin-on-arch live iso](https://github.com/gershwin-desktop/gershwin-on-arch/releases/tag/continuous), or the [GhostBSD Gershwin Community Preview live iso](https://www.ghostbsd.org/download).
