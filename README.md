...
* Gershwin can be built from source code in less than a few minutes on even low spec virtual machines with 1 GB memory 1 CPU using a First-class Clang/LLVM toolchain.
