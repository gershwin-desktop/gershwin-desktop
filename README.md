...
* Gershwin can be installed in under a few minutes by using [gershwin-developer](https://github.com/gershwin-desktop/gershwin-developer), which builds and installs Gershwin from source on FreeBSD, GhostBSD, NextBSD, OpenBSD, Arch, Artix, Debian, Devuan, Ubuntu, Void and Zorin.
