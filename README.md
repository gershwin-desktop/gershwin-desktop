...
* Will Gershwin ever support Wayland?  GNUstep has experimental wayland support.  
* Will Gershwin be Wayland only when that happens? There will be no effort to make Gerhswin wayland only.
